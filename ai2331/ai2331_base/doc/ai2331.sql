...
CREATE TABLE `sys_resource` (
  ...
  `enabled` tinyint(1) DEFAULT '1' COMMENT '是否生效：0 否；1 是',
  PRIMARY KEY (`id`),
  UNIQUE KEY `unique` (`priv_code`)
) ENGINE=InnoDB AUTO_INCREMENT=100034 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统功能入口';

/*Data for the table `sys_resource` */

insert  into `sys_resource`(`id`,`pid`,`priv_code`,`icon`,`name`,`resource_type`,`sort_order`,`url`,`tab_name`,`create_time`,`remark`,`enabled`) values (100,0,'admin','','系统管理',0,9999,'/sys',NULL,'2014-12-07 11:13:23','',1),(1100,100,'role_list','fa fa-users','角色管理',0,1,'/basic/roleList',NULL,'2014-12-07 11:11:08','',1),(1101,1100,'role_add','fa fa-wrench','添加角色',1,1,'/basic/roleAdd',NULL,'2014-12-07 11:15:30','',1),(1102,1100,'role_del','fa fa-wrench','删除角色',1,2,'/basic/roleDel',NULL,'2014-12-07 11:15:30',NULL,1),(1103,1100,'role_edit','fa fa-wrench','编辑角色',1,3,'/basic/roleEdit',NULL,'2014-12-07 11:17:31','',1),(1104,1100,'role_grant','fa fa-wrench','角色授权',1,4,'/basic/roleGrant',NULL,'2014-12-07 11:15:30',NULL,1),(1105,1100,'role_grid','fa fa-wrench','角色表格',1,5,'/basic/roleGrid',NULL,'2014-12-07 11:15:30',NULL,1),(1200,100,'res_list','fa fa-archive','资源管理',0,2,'/basic/resourceList',NULL,'2014-12-07 11:15:30','',1),(1201,1200,'res_add','fa fa-wrench','添加资源',1,1,'/basic/resourceAdd',NULL,'2014-12-07 11:15:30',NULL,1),(1202,1200,'res_del','fa fa-wrench','删除资源',1,2,'/basic/resourceDel',NULL,'2014-12-07 11:15:30',NULL,1),(1203,1200,'res_edit','fa fa-wrench','编辑资源',1,3,'/basic/resourceEdit',NULL,'2014-12-07 11:15:30',NULL,1),(1205,1200,'res_grid','fa fa-wrench','资源表格',1,5,'/basic/resourceGrid',NULL,'2014-12-07 11:15:30',NULL,1),(1300,100,'user_list','fa fa-user-circle-o','用户管理',0,3,'/basic/userList',NULL,'2014-12-07 11:15:30','',1),(1301,1300,'user_add','fa fa-wrench','添加用户',1,1,'/basic/userAdd',NULL,'2014-12-07 11:15:30',NULL,1),(1302,1300,'user_del','fa fa-wrench','删除用户',1,2,'/basic/userDel',NULL,'2014-12-07 11:15:30',NULL,1),(1303,1300,'user_edit','fa fa-wrench','编辑用户',1,3,'/basic/userEdit',NULL,'2014-12-07 11:15:30',NULL,1),(1304,1300,'user_pwd','fa fa-wrench','修改密码',1,4,'/basic/userPwd',NULL,'2014-12-07 11:15:30',NULL,1),(1305,1300,'user_grant','fa fa-wrench','用户授权',1,5,'/basic/userGrant',NULL,'2014-12-07 11:15:30',NULL,1),(100033,0,'test',NULL,'测试',0,0,'/abc',NULL,'2020-09-26 20:26:50',NULL,1);
